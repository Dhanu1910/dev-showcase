    ...
    >
      ...
      <div className="section-container relative z-10">
        <div className="max-w-4xl mx-auto text-center">
          {/* Profile Image */}
          <div className="relative inline-block mb-8 animate-fade-up opacity-0" style={{ animationFillMode: 'forwards' }}>
          ...
          {/* Greeting */}
          <p className="text-muted-foreground text-lg mb-4 animate-fade-up opacity-0 animation-delay-100" style={{ animationFillMode: 'forwards' }}>
            Hello, I'm
          </p>
          ...
          {/* CTA Buttons */}
          <div className="flex flex-col sm:flex-row gap-4 justify-center mb-12 animate-fade-up opacity-0 animation-delay-500" style={{ animationFillMode: 'forwards' }}>
            <Button
              variant="glow"
              size="lg"
